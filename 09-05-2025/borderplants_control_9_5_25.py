...
h.set_cmap(plt.get_cmap("viridis"))  # close to parula; keep default if you prefer
...
alpha = (~np.isnan(measVals)).astype(float)
h.set_alpha(alpha)  # hide NaNs (show background)
